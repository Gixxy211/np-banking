...
TwoNa.RegisterServerCallback("np-banking:Server:GetUserAccounts", function(source, data, cb) 
...
TwoNa.RegisterServerCallback("np-banking:Server:CreateAccount", function(source, data, cb) 
    local identifier = TwoNa.GetCharacterIdentifier(source)
...
TwoNa.RegisterServerCallback("np-banking:Server:DeleteAccount", function(source, data, cb) 
    local identifier = TwoNa.GetCharacterIdentifier(source)
...
TwoNa.RegisterServerCallback("np-banking:Server:DepositMoney", function(source, data, cb) 
    local identifier = TwoNa.GetCharacterIdentifier(source)
    local xPlayer = TwoNa.GetPlayer(source)
...
TwoNa.RegisterServerCallback("np-banking:Server:WithdrawMoney", function(source, data, cb) 
    local identifier = TwoNa.GetCharacterIdentifier(source)
    local xPlayer = TwoNa.GetPlayer(source)
...
TwoNa.RegisterServerCallback("np-banking:Server:TransferMoney", function(source, data, cb) 
    local identifier = TwoNa.GetCharacterIdentifier(source)
